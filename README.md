...
Promotion & Retrenchment Summary
...
Employee name, gender, department, and job role

Performance ratings and satisfaction scores

Promotion eligibility and retrenchment indicators
...
DAX Measures – for calculating KPIs like % Due for Promotion, % Retrench, % Female, etc.